...
**Session actuelle / notes** (maj 2026-05-25) — *Phase 0 en cours (~90 %)* :
...
- **Reste en Phase 0** : nav mobile (hamburger / menu) ; KPI calculés de la coque (`Avg Spread` / `Close Prob` encore à « — ») ; chart plein écran (zoom) différé ; activation Supabase ci-dessus.
